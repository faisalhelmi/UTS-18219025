...
fake_users_db = {
    "asdf": {
        "username": "asdf",
        "full_name": "Faisal Helmi Wicaksono",
        "email": "faisal.helmi.w@gmail.com",
        "hashed_password": "$2a$12$M/KYEmxtp6XhXpw118.K0.Hdcs1Okyl/XktoujmjyC/UNxnE7T3pe",
        "disabled": False,
    }
}
...
async def add_menu(name:str, current_user: User = Depends(get_current_active_user)):
    ...
    raise HTTPException(
        status_code=404, detail=f'Server Error'
    )
